...
; ground and the rocket (its height)

; LRCD -> Image
; renders the state as a resting or flying rocket

(check-expect (show "resting") (draw-rocket 0))
(check-expect
 (show -2)
 (place-image (text "-2" 20 "red")
              10 (* 3/4 WIDTH)
              (draw-rocket 0)))
(check-expect (show HEIGHT) (draw-rocket HEIGHT))
(check-expect (show 53) (draw-rocket 53))
(check-expect (show 0) (draw-rocket 0))
...
; Number -> Image
; draws the rocket, at the distance x from the ground
