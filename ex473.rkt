...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex473) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; A Node is a Symbol.
