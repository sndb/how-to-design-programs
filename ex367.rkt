  ...
  (local ((define optional-loa+content (rest xe)))
    (cond
      ...
      [else (... (first optional-loa+content)
             ... (map xexpr-attr (rest optional-loa+content)) ...)])))

; The parsing function is not concerned with attributes of Xexpr
; contents, thus it does not contain a self-reference.