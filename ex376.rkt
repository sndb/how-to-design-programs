...
; XEnum.v2 -> N
; counts all "hello"s in e

(check-expect (count-hello-enum `(ul (li ,w0)
                                     (li ,w2)))
              0)
(check-expect (count-hello-enum `(ul (li ,w0)
                                     (li ,w1)
...
(define (count-hello-enum e)
  (foldr + 0 (map count-hello-item (xexpr-content e))))

; XItem.v2 -> N
; counts all "hello"s in i

(check-expect (count-hello-item `(li ,w0)) 0)
(check-expect (count-hello-item `(li ,w1)) 1)

(define (count-hello-item i)
