...
(check-expect (eval-var-lookup expr-30 '()) 30)
(check-expect (eval-var-lookup expr-11 '()) 11)
(check-error (eval-var-lookup expr-5 '()) NO-ASSOCIATION)
(check-expect (eval-var-lookup expr-7.5 al-x5) 7.5)
(check-error (eval-var-lookup expr-34 al-x5) NO-ASSOCIATION)
(check-expect (eval-var-lookup expr-5 al-x5y3) 5)
(check-expect (eval-var-lookup expr-7.5 al-x5y3) 7.5)
(check-expect (eval-var-lookup expr-34 al-x5y3) 34)
...
(define NO-ASSOCIATION "eval-var-lookup: no association")